...
If installation failed using conda, then you can find and install a version of PyMOL for your computer [PyMOL Wiki](https://pymolwiki.org) or [https://pymol.org/](https://pymol.org/)
